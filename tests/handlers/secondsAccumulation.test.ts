...
beforeEach(() => {
    ...
    cp.weightFunctionType = "LINEAR";
    cp.weightFunctionP1 = BigInt.fromString("1000000000000000000"); // 1e18
    cp.weightFunctionP2 = BigInt.fromString("500000000000000000");  // 0.5e18
